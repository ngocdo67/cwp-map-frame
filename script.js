...
map.attributionControl
.setPrefix('Reference:' + '<br />' + '2009-14 American Community Survey 5-Year Estimates' + '<br />' + '2015 (2015 Benchmark) CT Dept. of Labor' + '<br />' + 'View <a href="http://github.com/ngocdo67/leaflet-map-panes">code on GitHub</a>, created with' + '<br />' +  '<a href="http://leafletjs.com" title="A JS library for interactive maps">Leaflet</a>');
...
$.getJSON("cwp-37-towns-v4.geojson", function (data) {   // insert pathname to your local directory file
